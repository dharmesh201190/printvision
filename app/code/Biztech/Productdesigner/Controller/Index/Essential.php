...
class Essential extends \Biztech\Productdesigner\Controller\Index {
    ...
    public function execute() {
        try {
            ...
            $result = $layout->setData(array("product_params" => $productParams, "page_title" => $pageTitle, "page_logo" => $pageLogo))->setTemplate('Biztech_Productdesigner::productdesigner/essential.phtml')->toHtml();
