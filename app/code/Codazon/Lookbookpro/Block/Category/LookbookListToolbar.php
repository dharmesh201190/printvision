...
use Codazon\Lookbookpro\Block\Lookbook\ListLookbook;
...
class LookbookListToolbar extends \Magento\Framework\View\Element\Template
{
    ...
    public function getWidgetOptionsJson(array $customOptions = [])
    {
        ...
        $options = [
            ...
            'modeDefault' => 'grid',//$defaultMode,
            'directionDefault' => 'asc',//$this->_direction ?: ProductList::DEFAULT_SORT_DIRECTION,
            'orderDefault' => 'position', //$this->_productListHelper->getDefaultSortField(),
            'limitDefault' => ListLookbook::DEFAULT_ITEMS_PER_PAGE,//$this->_productListHelper->getDefaultLimitPerPageValue($defaultMode),
