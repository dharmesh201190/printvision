...
class Interceptor extends \Nwdthemes\Revslider\Controller\Adminhtml\Revslider\Sliders implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\App\Action\Context $context, \Magento\Framework\View\Result\PageFactory $resultPageFactory, \Nwdthemes\Revslider\Helper\Framework $frameworkHelper)
    {
        $this->___init();
        parent::__construct($context, $resultPageFactory, $frameworkHelper);
    }
